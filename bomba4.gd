...
func _ready():
	get_node("/root/Node2D/Bomba4").body_entered.connect(_on_Area2D_body_enter)
	get_node("/root/Node2D/Bomba4").body_exited.connect(_on_Area2D_body_exit)

func _on_Area2D_body_enter( body ):
	print("Entrou BOMBA 4 ")
